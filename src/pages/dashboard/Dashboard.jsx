...
const SparkIcon = () => (
  ...
  <path d="M24.25 19.5V18.25C24.25 17.2554 24.6451 16.3016 25.3483 15.5983C26.0516 14.8951 27.0054 14.5 28 14.5C28.9946 14.5 29.9484 14.8951 30.6517 15.5983C31.3549 16.3016 31.75 17.2554 31.75 18.25V19.5" stroke="white" strokeWidth="1.875" strokeLinecap="round"/>
  </svg>
